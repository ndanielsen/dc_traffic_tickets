...
This will run all tests in the [`./dc_traffic_tickets/static/dc_traffic_tickets/__tests__`][test-dir] directory.
...
Open the lcov-report for an overview of your code coverage:
    ...
    $ open dc_traffic_tickets/static/dc_traffic_tickets/dist//reports/coverage/lcov-report/index.html
...
#### Source `./dc_traffic_tickets/static/dc_traffic_tickets/`
Main project source.

#### Actions `./dc_traffic_tickets/static/dc_traffic_tickets/actions/`
...
#### Components `./dc_traffic_tickets/static/dc_traffic_tickets/components/`
React components. Mostly __dumb__ components.

#### Constants `./dc_traffic_tickets/static/dc_traffic_tickets/constants/`
Stuff that doesn't change. Redux action types.

#### Containers `./dc_traffic_tickets/static/dc_traffic_tickets/containers/`
...
#### Reducers `./dc_traffic_tickets/static/dc_traffic_tickets/reducers/`
Reducer functions that take in the _current state_ and an _action type_ then return a new state.

#### Store `./dc_traffic_tickets/static/dc_traffic_tickets/store/`
...
[test-dir]: /dc_traffic_tickets/static/dc_traffic_tickets/__tests__/

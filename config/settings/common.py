# -*- coding: utf-8 -*-
"""
Django settings for DC Traffic Tickets project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (dc_traffic_tickets/config/settings/common.py - 3 = dc_traffic_tickets/)
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'dc_traffic_tickets.contrib.sites.migrations'
}
...
ADMINS = (
    ("""Nathan""", 'nathan.danielsen@gmail.com'),
)
...
ACCOUNT_ADAPTER = 'dc_traffic_tickets.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'dc_traffic_tickets.users.adapters.SocialAccountAdapter'
...
# EXPLORER_SCHEMA_EXCLUDE_APPS = ('allauth.**','dc_traffic_tickets.**', 'django.contrib.auth', 'django.contrib.contenttypes', 'django.contrib.sessions', 'django.contrib.admin')

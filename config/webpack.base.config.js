...
module.exports = (opts) => {
  ...
  return {
    ...
    entry: {
      main: path.resolve(PROJECT_ROOT, 'dc_traffic_tickets/static/dc_traffic_tickets/index'),
      vendor: ['react', 'redux', 'react-router', 'react-redux', 'react-dom'],
    },

    output: {
      path: path.resolve(PROJECT_ROOT, 'dc_traffic_tickets/static/dc_traffic_tickets/bundles'),
    ...
    resolve: {
      extensions: ['', '.js', '.jsx'],
      modules: [
        path.resolve(PROJECT_ROOT, 'dc_traffic_tickets/static/dc_traffic_tickets'),
        'node_modules',
      ],
    },
  };

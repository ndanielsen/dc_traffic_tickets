...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not os.path.isfile(self.dc_geo_maps_file):
            ...
            response = requests.get('https://s3.amazonaws.com/dctraffic/dc_geo_maps.zip', stream=True)
            ...
            if not response.ok:
                ...
                self.stdout.write(self.style.SUCCESS('Downloaded %s' % self.dc_geo_maps_file))

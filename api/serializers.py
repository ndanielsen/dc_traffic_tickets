...
class ParkingViolationSerializer(GeoFeatureModelSerializer):
    class Meta:
        ...
        geo_field = "point"
        exclude =  ('address_id', 'streetsegid', 'xcoord', 'ycoord', 'filename', 'rowid', 'objectid', 'violation_description' )
...
class GeoParkingViolationSerializer(GeoFeatureModelSerializer):
    class Meta:
        ...
        # exclude =  ('address_id', 'address', 'streetsegid', 'xcoord', 'ycoord', 'filename', 'rowid', 'objectid', 'violation_description' )
